    ...
    resultado_esperado = [
        {
            ...
            "Coluna8": "2023",
            "Conteudo": "... INTERESSADO(A): AAAAA AAAAAA AAAAAAA (CPF ***.123.268-**) ADVOGADO: GSSGSG GSGSG (OAB/XX 01.001) ASSUNTO: QUISQUE CONDIMENTUM - EXERCÍCIO DE 2023 EXERCÍCIO: 2023 INSTRUÇÃO POR: UR-20 PROCESSO(S) DEPENDENTES(S): 0000000010000 ASSUNTO: VESTIBULUM ANTE IPSUM PRIMIS IN FAUCIBUS ORCI LUCTUS ET ULTRICES.FUSCE QUIS ULLAMCORPER NULLA. MORBI FEUGIAT MI A METUS TINCIDUNT MAXIMUS. AENEAN DICTUM TORTOR NISI, ORNARE ANTE UT PURUS COMMODO INTERDUM. LOREM EM ORNARE ANTE UT PURUS COMMODO INTERDUM.SED CURSUS LOREM EGET LIBERO GRAVIDA, A ULTRICES NUNC PULVINAR...",
            "Tribunal": "tce_sp",
        },
        {
            ...
            "Coluna8": "2023",
            "Conteudo": "... VOLUTPAT LECTUS EU MASSA ALIQUAM,                       PELLENTESQUE HABITANT MORBI TRISTIQUE SENECTUS ET NETUS ET MALESUADA FAMES AC TURPIS EGESTAS. IN VITAE LACINIA MAGNA LOREM EM MAURIS LAOREET PORTA ODIO A GRAVIDA. PELLENTESQUE HABITANT MORBICLASS APTENT TACITI SOCIOSQU AD LITORA TORQUENT PER CONUBIA NOSTRA, PER INCEPTOS HIMENAEOS. ORBI TRISTIQUE SEN.CONSECTETUR TORTOR ARCU, A MOLESTIE MI PORTTITOR VEL. ETIAM VOLUTPAT LECTUS EU MASSA ALIQUAM, VITAE ACCUMSAN NULLA MAXIMUS. PRAESENT FERMENTUM, URNA IN AUCTOR IMPERDIET, SA F...",
            "Tribunal": "tce_sp",
        },
        {
            ...
            "Coluna8": "2023",
            "Conteudo": "...: DONEC PRETIUM, QUAM CONSECTETUR LAOREET FEUGIAT, EXERCÍCIO: XXXXINSTRUÇÃO POR: UR-20 PROCESSO(S) DEPENDENTES(S): 1245214ZZZZZ  ASSUNTO: MORBI TINCIDUNT GRAVIDA VULPUTATE. NAM SIT AMET TORTOR LIBEROPHASELLUS INTERDUM NEQUE ULLAMCORPER IACULIS BIBENDUM. SUSPENDISSE DIGNISSIM MOLESTIE. PHASELLUS INTERDUM NEQUE ULLAMCORPER IACULIS BIBENDUM. SUSPENDISSE DIGNISSIM MOLESTIE LOREM EM DUIS CONGUE MAGNA LACINIA ELIT CONGUE ALIQUAM. CRAS DICTUM AC TURPIS AC MOLLIS. SUSPENDISSE VELIT NIBH, EFFICITUR SIT AMET COMMODO A, POSUERE FRINGILLA DUI. PROIN IMPERDIET, NEQUE SED PELLENTESQUE GRAVIDA, MASSA NIBH PORTA SEM, A FACILISIS ORCI VELIT COMMODO LOREM. MAURIS VITAE PULVINAR TORTOR. VIVAMUS PORTTITOR DIAM UT ULTRICES CONVALLIS. PELLENTESQUE BIBENDUM EX QUIS SEM EGESTAS VIVERRA ID ACCUMSAN NULLA.NAM SOLLICITUDIN, LOREM SED...",
            "Tribunal": "tce_sp",
        },
        {
        ...
        },
        {
            ...
            "Coluna8": "2023",
            "Conteudo": "...SED UT TURPIS AUGUESED UT TURDSFSFPIS AUGUE(11) 000001--0144 - GCDER@TDAF.CSDD D D P A C Z O\xa0PROCESSO: 000001-0417448UT SCELERISQUE AUGUE SEM, EGET EGESTAS LEO AUCTOR SED. PELLENTESQUE A MI A TELLUS DAPIBUS DIGNISSIM. SED FAUCIBUS FERMENTUM CONSEQUAT. ETIAM IPSUM LECTUS, CONGUE AT ELIT SIT AMET, CONSEQUAT ULTRICIES NULLA. SED DICTUM NIBH IN SODALES CONSEQUAT. UT VITAE PRETIUM VELIT, AT AUCTOR LECTUS. NUNC NON LIBERO EU RISUS DICTUM ELEMENTUM. ETIAM NEC VULPUTATE EST. NUNC DIGNISSIM ET NULLA IN ELEIFEND. INTEGER NISL LIGULA, PELLENTESQUE IN FRINGILLA IN, FINIBUS EU ANTE. QUISQUE EFFICITUR AT NEQUE AT SODALES. LOREM ONSEQUAT ULTRICIES NULLANIBH IN SODALES CONSEQUA...",
            "Tribunal": "tce_sp",
        },
        {
            ...
            "Coluna8": "2023",
            "Conteudo": "... SENECTUS ET NETUS ET MALESUADA . FAMES AC TURPIS EGESTAS. IN MI NEQUE,ALIQUAM NISI TURPIS, ALIQUAM ET LOBORTIS VEL, MOLESTIE SIT AMET TORTOR. NULLA NON NISL UT NULLA PHARETRA FINIBUS. CURABITUR RUTRUM ODIO VITAE LIBERO GRAVIDA INTERDUM IN SIT AMET LOREM. DUIS ID PLACERAT NEQUE, EU CONVALLIS EMENDATA: REPRFSFÇÃO. LIFSAÇÃO. PARTFSSFETÇÃO DETR EMFSDFS CJUJFSS SÓCIJFELOS TUM RELAÇHFO DE PMARENTELJSCO. AUVXCIA DE VÇÃO LEVXL. AUSÊVDE INDÍCMJ DE LOREM . NBD PROVFTE. QUISQUE SCELERISQUE ODIO AT RISUS DIGNISSIM, VOLUTPAT EFFICITUR JUSTO PLACERAT...",
            "Tribunal": "tce_sp",
        },
        {
